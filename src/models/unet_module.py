...
class UNETLitModule(LightningModule):
    """Example of a `LightningModule` for UNET segmentation."""
    def __init__(
        self,
        net: torch.nn.Module,
        ...
        # loss function
        self.criterion = DiceLoss(sigmoid=True,squared_pred=True,reduction="mean")
        # metric objects for calculating and averaging accuracy across batches
        self.train_iou = MeanIoU()
        self.val_iou = MeanIoU()
        self.test_iou = MeanIoU()

        self.train_ap = MeanAveragePrecision()
        self.val_ap = MeanAveragePrecision()
        self.test_ap = MeanAveragePrecision()
    ...
    def training_step(
        ...
        self.log("train/ap", self.train_ap, on_step=False, on_epoch=True, prog_bar=True)
...
if __name__ == "__main__":
    _ = UNETLitModule(None, None, None, None)
